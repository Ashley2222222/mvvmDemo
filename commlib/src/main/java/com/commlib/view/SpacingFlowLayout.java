...
public class SpacingFlowLayout extends ViewGroup {
    ...
    public SpacingFlowLayout(Context context) {
        this(context, null);
    }

    public SpacingFlowLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SpacingFlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
