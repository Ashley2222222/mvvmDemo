...
public class MD5 {
	...
	public static void main(String[] args) {
		MD5 md = new MD5();
		System.out.println(getMD5ofStr("12"));
	}
	 ...
	 * 简单的位运算，可能出于效率的考虑把它们实现成了宏，在java中，我们把它们 实现成了private static方法，名字保持了原来C中的。
	 */
	 ...
	 * 函数由getMD5ofStr调用，调用之前需要调用md5init，因此把它设计成private static的
	 */
	 ...
	 * MD5 算法的Java Bean
	 *
	 * @author:Topcat Tuppin Last Modified:10,Mar,2001 Last AD:Ndk
	 * @version 1.00.00.01
	 **************************************************************************/
